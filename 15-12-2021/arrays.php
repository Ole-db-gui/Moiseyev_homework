...
<body>
    ...
    <main>
        ...
        <div>
            ...
            function displayElementsWithFirstA($array) {
                for ($i = 0; $i < count($array); $i++) {
                    for ($j = 0; $j < count($array[$i]); $j++) {
                        if (mb_stripos($array[$i][$j], 'A') === 0) {
                            echo $array[$i][$j]."<br>";
                        }
                    }
                }
            }
            displayElementsWithFirstA($array2);
            ?>
        </div>
        <div>
            <h2>
            ...
            <?php
            function randomArrayAndCountDirections() {
                $x = mt_rand(2,5);
                $y = mt_rand(2,8);
                $counterRow = 0;
                $counterCol = 0;
