        ...
        <div class="block_about">
            ...
            <div class="block_about-text">
                ...
                <div class="block_about-feedback">
                    <?php
                        $feedbackString = 'Благодарю за предоставленную возможность обучения и потенциального трудоустройства в вашу компанию!
                    Изучив структуру курса, включая вынесенные на собственное прохождение объемы курсов по системам Bitrix, можно сделать вывод, что протяженность курса обучения 3 месяца - является оптимальной. С одной стороны может показаться, что материала
                        для изучения очень много и он подается сжато, а с другой стороны по структуре курс выстроен очень хорошо и логично. При усердном подходе и полной фокусировке - возможно освоить необходимый стек технологий для трудоустройства разработчиком.
                    Решение организовать обучение удаленно является плюсовым, так как каждый находится на своём комфортном рабочем месте и не тратит времени на дорогу до аудитории, при этом нет никакого ущерба качеству обучения.';
