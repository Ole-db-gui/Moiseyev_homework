    ...
    <main>
        <div class="block_about">
            ...
            <div class="block_about-text">
                ...
                <div class="block_about-info"><span>Мне 26 лет, ранее несколько лет проектировал автоматизированные системы управления для металлургических заводов в одном из крупнейших проектных институтов нашей страны.</span>
                ...
                <div class="block_about-feedback"><p>Благодарю за предоставленную возможность обучения и потенциального трудоустройства в вашу компанию!</p>
