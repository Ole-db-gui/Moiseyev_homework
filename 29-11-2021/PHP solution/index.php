...
<body>
    ...
    <main>
        ...
        <div class="black-line">
            <?php
                $totalWords = str_word_count($name.$aboutInfo.$feedback.$titleBreed.$abissinskaya.$savannah.$angorskaya.$korat.$titleColor.$solid.$tabby.$white.$russianBlue);
                $dateAndTime = date('D, d-M-Y H:i');
                $totalVowels = preg_match_all('/[аеёиоуыэюяaeiou]/iu', $name.$aboutInfo.$feedback.$titleBreed.$abissinskaya.$savannah.$angorskaya.$korat.$titleColor.$solid.$tabby.$white.$russianBlue);
                $date = explode('-','11-01-1995');
                ...
                echo "<p>Слов на странице по мнению PH: $totalWords</p>";
